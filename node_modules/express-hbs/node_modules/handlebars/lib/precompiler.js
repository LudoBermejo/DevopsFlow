...
module.exports.cli = function(opts) {
  ...
  if (opts.simple && multiple) {
    throw new Handlebars.Exception('Unable to output multiple views in simple mode');
  }
  ...
  const objectName = opts.partial ? 'Handlebars.partials' : 'views';
  ...
  if (!opts.simple) {
    ...
    output.add('  var template = Handlebars.template, views = ');
    if (opts.namespace) {
