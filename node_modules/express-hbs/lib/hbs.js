...
/**
 * Cache partial views found under directories configure in partialsDir.
 */
...
ExpressHbs.prototype.express3 = function(options) {
  ...
  // Cache for views, express 3.x doesn't do this for us
  this.cache = {};
 ...
 * @param {Object} options Is the context or locals for views. {
...
ExpressHbs.prototype.___express = function ___express(filename, source, options, cb) {
  ...
  function render(template, locals, layoutTemplates, cb) {
    ...
    // We'll render views from bottom to top of the stack, each template
